...
public final class ModelBuilder {
    ...
    public static final class EntityBuilder<T> {
        ...
        public EntityBuilder<T> hasId(String column) {
            return hasId(column, column, true);
        }
        ...
        public EntityBuilder<T> hasId(String property, String column, boolean autoGenerated) {
            /*this.idProp = property;
            this.idCol = column;
            this.idAuto = autoGenerated;
            ...
            if (autoGenerated && !this.keys.isEmpty()) {
                throw new IllegalArgumentException("auto=true not supported when multiple ID columns are declared for type: " + this.type.getName());
            }
